...
<html>
    ...
    <body style="background-image: url(img/fondo1.jpg)">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color: transparent!important; box-shadow: 0 4px 8px rgb(0,0,0,0.3); border: 1px solid whitesmoke">
